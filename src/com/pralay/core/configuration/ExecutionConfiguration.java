...
/**
 * Contains configuration paramters for AppContext.
 */
public class ExecutionConfiguration {
    ...
    private void setFromEnvironment() {
        ...
        // infer that the app runs externally based on missing App env variables
        if (!envs.containsKey("SQL_PASSWORD")) { //TODO would be safer to have a special purpose variable, eg. App_INTERNAL=1
            LOG.info("Application configured as EXTERNAL to App (WARN: temporarily using $SQL_PASSWORD env variable to make the decision - a proper variable needs to be added).");
            setAppAsExternal();
        }
    }
    ...
    /**
     * @return the App application name
     */
